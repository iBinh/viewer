...
public sealed class Localizer : INotifyPropertyChanged
{
    ...
    private static readonly IReadOnlyDictionary<string, string> English = new Dictionary<string, string>
    {
        ...
        ["Discovery.Sweep.SummaryLocal"] = "Deep scan will sweep this machine's own subnet.",
        ["Discovery.IpRange.Invalid"] = "Not a valid IP range. Use 192.168.1.0/24, 192.168.1.10-200, or a single address.",
        ["Discovery.IpRange.TooLargeFormat"] = "Too many addresses selected (max {0}). Untick a subnet, or narrow the typed range.",
        ...
        ["Ptz.SetHome"] = "Set home here",
        ["Ptz.SetHome.Title"] = "Set home position",
        ["Ptz.SetHome.Message"] = "Make the camera's current position its home? The old home position is replaced.",
        ["Ptz.Speed"] = "Move speed",
        ["Ptz.ZoomIn"] = "Zoom in one step",
        ["Ptz.ZoomOut"] = "Zoom out one step",
    ...
    private static readonly IReadOnlyDictionary<string, string> Russian = new Dictionary<string, string>
    {
        ...
        ["Discovery.Sweep.SummaryLocal"] = "Глубокое сканирование обойдёт подсеть этого компьютера.",
        ["Discovery.IpRange.Invalid"] = "Неверный диапазон IP. Например: 192.168.1.0/24, 192.168.1.10-200 или один адрес.",
        ["Discovery.IpRange.TooLargeFormat"] = "Слишком много адресов (макс. {0}). Снимите отметку с подсети или сузьте введённый диапазон.",
        ...
        ["Ptz.Home"] = "Перейти в домашнюю позицию",
        ["Ptz.SetHome"] = "Сделать текущую позицию домашней",
        ["Ptz.SetHome.Title"] = "Задать домашнюю позицию",
        ["Ptz.SetHome.Message"] = "Сделать текущую позицию камеры домашней? Прежняя домашняя позиция будет заменена.",
        ["Ptz.Speed"] = "Скорость перемещения",
        ["Ptz.ZoomIn"] = "Приблизить на шаг",
        ["Ptz.ZoomOut"] = "Отдалить на шаг",
